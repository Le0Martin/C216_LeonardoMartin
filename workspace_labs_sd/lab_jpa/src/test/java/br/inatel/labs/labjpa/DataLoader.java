...
class DataLoader {
	...
	void Load() {
		...
		nc1 = notaCompraService.salvar(nc2);
		...
		i1_1 = notaCompraService.salvarNotaCompraItem(i2_1);
		i1_2 = notaCompraService.salvarNotaCompraItem(i2_2);
		i1_3 = notaCompraService.salvarNotaCompraItem(i2_3);
